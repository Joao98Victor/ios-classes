...
//  Exercicio Json e Table
//
//  Created by Usuário Convidado on 08/10/2018.
//  Copyright © 2018 Joao Victor. All rights reserved.
//
...
class ListaTableViewController: UITableViewController {
                ...
                if error != nil {
                    ...
                    do{
                        ...
                        for resultado in resultados {
                            ...
                            guard let loca = resultado["location"] as? [String:Any] else { return }
                            guard let cidade = loca["city"] as? String else { return }
                            guard let rua = loca["street"] as? String else { return }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = aplicativoArray[indexPath.row].nome + " - Gênero " + aplicativoArray[indexPath.row].genero
